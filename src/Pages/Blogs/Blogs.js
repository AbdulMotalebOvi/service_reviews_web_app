...
const Blogs = () => {
    return (
        <div className='max-w-screen-xl mx-auto my-20 space-y-6'>
            ...
            <div tabIndex={0} className="collapse collapse-plus border border-base-300 bg-base-100 rounded-box  lg:w-1/2 sm:w-full m-auto ">
            ...
            <div tabIndex={0} className="collapse collapse-plus border border-base-300 bg-base-100 rounded-box w-1/2 m-auto">
                <div className="collapse-title text-xl font-medium">
